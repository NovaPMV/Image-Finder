...
#  typing a phrase ("girl wearing jeans", "sunset over water", "red car") and
...
<body>
<header><h1>ImageFinder <span style="font-weight:400;color:#9aa0aa;font-size:14px">- search your images by describing them</span></h1></header>
...
<div class="row" id="topnav" style="align-items:center">
  <div style="flex:1; display:flex; gap:10px; align-items:center; min-width:0;">
    <input id="searchbar" type="text" placeholder='Search e.g. "sunset over water"'
